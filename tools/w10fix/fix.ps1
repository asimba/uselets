...
function fix-tasks-files(){
    ...
    foreach ($tpath in $tpaths) {
        Get-ChildItem -ea SilentlyContinue -Path "$env:systemroot$tpath" * | foreach {
            Takeown-File $_.FullName
            Remove-Item -ea SilentlyContinue -Path $_.FullName
        }
    }
}
...
function fix-telemetry() {
    ...
    reg add "HKLM\Software\Policies\Microsoft\InputPersonalization\TrainedDataStore" /v "HarvestContacts" /t REG_DWORD /d "0" /f 
    ...
    reg add "HKCU\Software\Policies\Microsoft\InputPersonalization\TrainedDataStore" /v "HarvestContacts" /t REG_DWORD /d "0" /f 
...
#    reg add "HKCU\SOFTWARE\Policies\Microsoft\Windows\Explorer" /v DisableNotificationCenter /t REG_DWORD /d 1 /f
    ...
    reg add "HKCU\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Sensor\Permissions\{E6AD100E-5F4E-44CD-BE0F-2265D88D14F5}" /v "SensorPermissionState" /t REG_DWORD /d "0" /f
    ...
    reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{00EEBD44-EB0F-4A94-A2D4-D5C4ED5FA66D}" /v "Value" /t REG_SZ /d "Deny" /f
    ...
    reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{B1920448-233F-46CA-98E3-0839305F2141}" /v "Value" /t REG_SZ /d "Deny" /f
    ...
    reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\StartupNotify" /v "EnableStartupAppNotification" /t REG_DWORD /d "0" /f
    ...
    reg delete "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\SessionInfo\1" /f
    reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\SessionInfo\1" /v "Value" /t REG_SZ /d "Deny" /f
    Set-Registry-ReadOnly "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\SessionInfo\1"
    reg delete "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\SessionInfo" /f
    reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\SessionInfo" /v "Value" /t REG_SZ /d "Deny" /f
    Set-Registry-ReadOnly "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\SessionInfo"
    reg delete "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager\SuggestedApps" /f
    reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager\SuggestedApps" /v "Value" /t REG_SZ /d "Deny" /f
    Set-Registry-ReadOnly "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager\SuggestedApps"
}
...
function cleanup(){
    ...
    write-header "Deleting temp folders..."
    ...
    write-header "Removing system and user temp Files"
...
function clear-tiles(){
    ...
    reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\MultiTaskingView" /f
    reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\MultiTaskingView" /v "AllUpView" /t REG_DWORD /d "0" /f
