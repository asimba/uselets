...
g++ -Os -m32 -mwindows -march=i686 -mtune=i686 -s -Wall -fmerge-constants -fno-builtin -fno-rtti ^
-fno-stack-protector -fno-exceptions -fno-ident -nostartfiles ^
-Wl,--entry=_WinMain,--enable-stdcall-fixup,--no-insert-timestamp,--nxcompat  -o fixes.exe ^
src\sfx.cc ^
src\rsrc.o
