...
Потребуется выполнить *на свой страх и риск* _ru-certs-20230325.exe_ из прилагающегося архива.  
_Примечание:_ набор сертификатов подготовлен на основании перечня аккредитованных УЦ по данным портала уполномоченного федерального органа в области использования электронной подписи ( [Портал УФО](https://e-trust.gosuslugi.ru/#/portal/accreditation/accreditedcalist) ) за март 2023 года.  
