...
_Примечание: сценарий тестировался на Windows 10 22H2 (версии 10.0.19045.2913) и Windows 11 22H2 (версии 10.0.22621.1635)._  
...
_Требования (зависимости):_ [ru-certs-202303](https://github.com/asimba/uselets/raw/main/tools/ru-cert/bin/ru-certs-202303.zip)  
Потребуется выполнить **на свой страх и риск** _ru-certs-202303.exe_ из прилагающегося архива.  
