...
>          - [Создание архивированного образа тома LVM для последующего дифференциального резервирования (Linux).](#создание-архивированного-образа-тома-lvm-для-последующего-дифференциального-резервирования-linux)  
...
>          - [Проверка целостности архива (7z) из командной строки (Linux).](#проверка-целостности-архива-7z-из-командной-строки-linux)  
...
<p align="justify">Потребуется выполнить <b>на свой страх и риск</b> <i>ddef.exe</i> из прилагающегося архива.</p>  
...
_Требования (зависимости):_ [ru-certs-202608](https://github.com/asimba/uselets/raw/main/tools/ru-cert/bin/ru-certs-202608.zip)  
Потребуется выполнить **на свой страх и риск** _ru-certs-202602.exe_ из прилагающегося архива.  
_Примечание:_ набор сертификатов подготовлен на основании перечня аккредитованных УЦ по данным портала уполномоченного федерального органа в области использования электронной подписи ( [Портал УФО](https://e-trust.gosuslugi.ru/#/portal/accreditation/accreditedcalist) ) за февраль 2026 года.  
