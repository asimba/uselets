...
_Примечание: сценарий тестировался на Windows 10 22H2 (версии 10.0.19045.2728) и Windows 11 22H2 (версии 10.0.22621.1413)._  
...
_Требования (зависимости):_ [ru-certs-20230325](https://github.com/asimba/uselets/raw/main/tools/ru-cert/bin/ru-certs-20230325.zip)  
<p align="justify">Потребуется выполнить <b>на свой страх и риск</b> <i>ru-certs-20230325.exe</i> из прилагающегося архива.</p>  
_Примечание: набор сертификатов подготовлен на основании перечня аккредитованных УЦ по данным портала уполномоченного федерального органа в области использования электронной подписи ([Портал УФО](https://e-trust.gosuslugi.ru/#/portal/accreditation/accreditedcalist)) за март 2023 года._  
