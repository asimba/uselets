...
>          - [Комплексное решение: отключение (снижение активности) Windows Defender (Windows 10/11), удаление bloatware, отключение телеметрии и автообновлений Windows 10.](#комплексное-решение-отключение-снижение-активности-windows-defender-windows-1011-удаление-bloatware-отключение-телеметрии-и-автообновлений-windows-10)  
...
_Примечание: сценарий тестировался на Windows 10 21H2 (версии 10.0.19044.2006) и Windows 11 21H2 (версии 10.0.22000.978)._  
