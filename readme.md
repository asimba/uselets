...
_Примечание: сценарий тестировался на Windows 10 22H2 (версии 10.0.19045.6691) и Windows 11 24H2 (версии 10.0.26200.7462)._  
...
Потребуется выполнить **на свой страх и риск** _ru-certs-202505.exe_ из прилагающегося архива.  
_Примечание:_ набор сертификатов подготовлен на основании перечня аккредитованных УЦ по данным портала уполномоченного федерального органа в области использования электронной подписи ( [Портал УФО](https://e-trust.gosuslugi.ru/#/portal/accreditation/accreditedcalist) ) за май 2025 года.  
